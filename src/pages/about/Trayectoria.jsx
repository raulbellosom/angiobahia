...
const Trayectoria = () => {
  return (
    <div className="container mx-auto">
      ...
      >
        <div className="w-full md:w-fit flex flex-col items-center md:flex-row gap-1 md:gap-4 translate-y-32 md:translate-x-24 md:translate-y-20">
      ...
      <div className="p-4 pt-10 md:p-10 md:px-24 md:pt-0 lg:px-32 flex flex-col md:gap-4 items-center justify-center">
