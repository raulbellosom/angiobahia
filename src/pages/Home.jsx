  ...
  return (
    <div className="min-h-screen h-full">
      <Carousel slideInterval={7000} className="min-h-screen h-screen">
        ...
        >
          <div className="flex flex-col md:grid md:grid-cols-2 md:justify-center w-full h-full items-center gap-4">
        ...
        <div
          ...
          className="p-5 md:px-20 flex h-full items-center md:justify-center bg-gray-400 dark:bg-gray-700 dark:text-white"
        >
          <div className="flex flex-col md:grid md:grid-cols-2 md:justify-center w-full h-full items-center gap-4">
            <div className="flex flex-col md:justify-center gap-4 h-full">
